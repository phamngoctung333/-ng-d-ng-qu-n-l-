...
Route::post('cbql_xoa_phong/{id}', 'CanboController@xoa_phong')->name('cbql_xoa_phong');
Route::put('sua_phong/{id}','CanboController@sua_phong')->name('sua_phong');
...
Route::get('xemsv','CanboController@xemsv')->name('xemsv');
Route::put('capnhatSinhVien/{mssv}', 'CanboController@capnhatSinhVien')->name('capnhatsv');
Route::delete('delete-student/{email}', 'CanboController@deleteStudent')->name('delete_student');
...
Route::get('admin_ttsv','PageController@admin_ttsv')->name('admin_ttsv');
Route::get('xem_ttsv/{mssv}','CanboController@xem_ttsv')->name('xem_ttsv');
Route::post('info_sv','LoadController@search');
Route::get('cbql_sv', 'CanboController@cbql_sv')->name('cbql_sv');
#-----------Thống kê----------------------------------------------------------------------------------------------------
...
#-----------------Admin---------------------
#--------------Danh sách khu----------------
Route::get('admin_khu','CanboController@admin_khu')->name('admin_khu');
Route::get('phongkhu/{id}','CanboController@phongkhu')->name('phongkhu');
Route::post('store','CanboController@store')->name('store');
Route::delete('destroy/{id}','CanboController@destroy')->name('destroy');
Route::put('update/{id}','CanboController@update')->name('update');
#--------------Danh-sách-cán-bộ-------------
